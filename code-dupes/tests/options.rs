//! Shared option-handling suite stamped against the `code-dupes` binary.
...
dupes_cli_test_support::cli_support_tests! {
    ...
    exclude_option => dupes_cli_test_support::exclude_option(true, "No source files");
    ...
    error_on_nonexistent_path => dupes_cli_test_support::error_on_nonexistent_path("No recognized source files");
